...
public class ImageUtils {
  ...
  @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1) public static Bitmap renderScriptBlur(
      Context context, Bitmap src, float radius) {
    if (isEmptyBitmap(src)) return null;
  ...
  public static Bitmap addReflection(Bitmap src, int reflectionHeight) {
    ...
    Bitmap out = Bitmap.createBitmap(srcWidth, srcHeight + reflectionHeight, Config.ARGB_8888);
    ...
    LinearGradient shader =
        new LinearGradient(0, srcHeight, 0, out.getHeight() + REFLECTION_GAP, 0x70FFFFFF,
  ...
  private Bitmap compress(Bitmap src, CompressFormat format, long topLimit,
      ConstantUtils.MemoryUnit unit, boolean recycle) {
