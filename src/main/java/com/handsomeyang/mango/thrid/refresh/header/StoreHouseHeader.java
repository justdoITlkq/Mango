package com.handsomeyang.mango.thrid.refresh.header;
...
import com.handsomeyang.mango.thrid.refresh.PtrFrameLayout;
import com.handsomeyang.mango.thrid.refresh.PtrUIHandler;
import com.handsomeyang.mango.thrid.refresh.indicator.PtrIndicator;
import com.handsomeyang.mango.thrid.refresh.util.PtrLocalDisplay;
...
public class StoreHouseHeader extends View implements PtrUIHandler {
  ...
  public void initWithPointList(ArrayList<float[]> pointList) {
    ...
    for (int i = 0; i < pointList.size(); i++) {
      ...
      PointF startPoint = new PointF(PtrLocalDisplay.dp2px(line[0]) * mScale,
          PtrLocalDisplay.dp2px(line[1]) * mScale);
      PointF endPoint = new PointF(PtrLocalDisplay.dp2px(line[2]) * mScale,
          PtrLocalDisplay.dp2px(line[3]) * mScale);
      ...
      StoreHouseBarItem item =
          new StoreHouseBarItem(i, startPoint, endPoint, mTextColor, mLineWidth);
