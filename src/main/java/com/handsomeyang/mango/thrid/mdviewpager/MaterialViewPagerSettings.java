package com.handsomeyang.mango.thrid.mdviewpager;
...
import static com.handsomeyang.mango.thrid.mdviewpager.Utils.pxToDp;
...
public class MaterialViewPagerSettings implements Parcelable {
  ...
  public static final Creator<MaterialViewPagerSettings> CREATOR =
      new Creator<MaterialViewPagerSettings>() {
  ...
  protected int smartTablayoutId;
  ...
  private MaterialViewPagerSettings(Parcel in) {
    ...
    this.smartTablayoutId = in.readInt();
  ...
  @Override public void writeToParcel(Parcel dest, int flags) {
    ...
    dest.writeInt(this.smartTablayoutId);
  ...
  protected void handleAttributes(Context context, AttributeSet attrs) {
    try {
      ...
      //{
      //  pagerTitleStripId =
      //      styledAttrs.getResourceId(R.styleable.MaterialViewPager_viewpager_pagerTitleStrip, -1);
      //  if (pagerTitleStripId == -1) {
      //    pagerTitleStripId = R.layout.material_view_pager_pagertitlestrip_standard;
      //  }
      {
        smartTablayoutId =
            styledAttrs.getResourceId(R.styleable.MaterialViewPager_viewpager_smartTabLayout, -1);
        if (smartTablayoutId == -1) {
          smartTablayoutId = R.layout.material_view_pager_smarttablayout_default;
        }
      }
      {
        viewpagerId =
      ...
      }
      {
        ...
        logoMarginTop =
            styledAttrs.getDimensionPixelSize(R.styleable.MaterialViewPager_viewpager_logoMarginTop,
                0);
      }
      {
      ...
      }
      {
        headerHeightPx = styledAttrs.getDimensionPixelOffset(
            R.styleable.MaterialViewPager_viewpager_headerHeight, 200);
      ...
      }
      {
        headerAdditionalHeight = styledAttrs.getDimensionPixelOffset(
            R.styleable.MaterialViewPager_viewpager_headerAdditionalHeight, 60);
      }
      {
        headerAlpha =
      ...
      {
        imageHeaderDarkLayerAlpha =
            styledAttrs.getFloat(R.styleable.MaterialViewPager_viewpager_imageHeaderDarkLayerAlpha,
                0.0f);
      }
      {
        parallaxHeaderFactor =
            styledAttrs.getFloat(R.styleable.MaterialViewPager_viewpager_parallaxHeaderFactor,
                1.5f);
        parallaxHeaderFactor = Math.max(parallaxHeaderFactor, 1); //min=1
      }
      {
        hideToolbarAndTitle =
            styledAttrs.getBoolean(R.styleable.MaterialViewPager_viewpager_hideToolbarAndTitle,
                false);
        hideLogoWithFade =
            styledAttrs.getBoolean(R.styleable.MaterialViewPager_viewpager_hideLogoWithFade, false);
      }
      {
        enableToolbarElevation =
            styledAttrs.getBoolean(R.styleable.MaterialViewPager_viewpager_enableToolbarElevation,
                false);
      }
      {
        displayToolbarWhenSwipe =
            styledAttrs.getBoolean(R.styleable.MaterialViewPager_viewpager_displayToolbarWhenSwipe,
                false);
      }
      {
        toolbarTransparent =
            styledAttrs.getBoolean(R.styleable.MaterialViewPager_viewpager_transparentToolbar,
                false);
      }
      {
        animatedHeaderImage =
      ...
      {
        disableToolbar =
            styledAttrs.getBoolean(R.styleable.MaterialViewPager_viewpager_disableToolbar, false);
      }
      styledAttrs.recycle();
    } catch (Exception e) {
      e.printStackTrace();
