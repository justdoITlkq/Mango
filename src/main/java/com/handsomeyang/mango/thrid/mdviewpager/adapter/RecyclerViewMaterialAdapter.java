package com.handsomeyang.mango.thrid.mdviewpager.adapter;
 ...
 */
@Deprecated public class RecyclerViewMaterialAdapter
  ...
  /**
   * Construct the RecyclerViewMaterialAdapter, which inject a header into an actual
  ...
  @Override public int getItemViewType(int position) {
    if (position < mPlaceholderSize) {
      ...
      return mAdapter.getItemViewType(
          position - mPlaceholderSize); //call getItemViewType on the adapter, less mPlaceholderSize
    }
  }
