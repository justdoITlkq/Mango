package com.handsomeyang.mango.thrid.mdviewpager.viewcontroller;
...
import com.handsomeyang.mango.thrid.mdviewpager.MaterialViewPagerHelper;
...
public class ViewController {
  ...
  public void materialAdapter(View view, String mappedName, String layoutName) {
    ...
    if (carpaccio != null && layoutResId != -1 && view instanceof RecyclerView) {
      ...
      MaterialCarpaccioRecyclerViewAdapter adapter =
          new MaterialCarpaccioRecyclerViewAdapter(recyclerColumnCount, carpaccio, layoutResId,
              mappedName);

      commonViewController.setAdapterForRecyclerView(view, mappedName, layoutName, adapter);

      MaterialViewPagerHelper.registerRecyclerView((Activity) view.getContext(),
          (RecyclerView) view);
    }
  }
  ...
  public class MaterialCarpaccioRecyclerViewAdapter extends CarpaccioRecyclerViewAdapter {
    ...
    public MaterialCarpaccioRecyclerViewAdapter(int mPlaceholderSize, Carpaccio carpaccio,
        int layoutResId, String mappedName) {
      super(carpaccio, layoutResId, mappedName);
      this.mPlaceholderSize = mPlaceholderSize;
    }

    public int getItemViewType(int position) {
      if (position < mPlaceholderSize) return TYPE_PLACEHOLDER;
    ...
    @Override public Object getItemForRow(View view, int position) {
