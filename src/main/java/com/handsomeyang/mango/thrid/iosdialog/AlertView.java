package com.handsomeyang.mango.thrid.iosdialog;
...
public class AlertView {
  ...
  protected void initViews() {
    ...
    decorView = (ViewGroup) ((Activity) context).getWindow()
        .getDecorView()
    ...
    switch (style) {
      case ActionSheet:
        ...
        margin_alert_left_right =
            context.getResources().getDimensionPixelSize(R.dimen.margin_actionsheet_left_right);
      ...
      case Alert:
        ...
        margin_alert_left_right =
            context.getResources().getDimensionPixelSize(R.dimen.margin_alert_left_right);
  ...
  protected void initListView() {
    ...
    ListView alertButtonListView =
        (ListView) contentContainer.findViewById(R.id.alertButtonListView);
    //把cancel作为footerView
  ...
  protected void initActionSheetViews(LayoutInflater layoutInflater) {
    ViewGroup viewGroup =
        (ViewGroup) layoutInflater.inflate(R.layout.layout_alertview_actionsheet, contentContainer);
  ...
  protected void initAlertViews(LayoutInflater layoutInflater) {
    ...
    ViewGroup viewGroup =
        (ViewGroup) layoutInflater.inflate(R.layout.layout_alertview_alert, contentContainer);
    initHeaderView(viewGroup);
    ...
    if (mDatas.size() <= HORIZONTAL_BUTTONS_MAXCOUNT) {
      ...
      viewStub.inflate();
      LinearLayout loAlertButtons =
          (LinearLayout) contentContainer.findViewById(R.id.loAlertButtons);
      for (int i = 0; i < mDatas.size(); i++) {
        ...
        //高亮按钮的样式
          ...
          tvAlert.setTextColor(
              context.getResources().getColor(R.color.textColor_alert_button_destructive));
        }

        tvAlert.setOnClickListener(new OnTextClickListener(position));
        position++;
        loAlertButtons.addView(itemView,
  ...
  //utuils 工具类
  public static class AlertAnimateUtil {
