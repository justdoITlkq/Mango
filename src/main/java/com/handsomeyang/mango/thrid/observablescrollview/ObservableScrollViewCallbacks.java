...
public interface ObservableScrollViewCallbacks {
   ...
   * @param firstScroll True when this is called for the first time in the consecutive motion
   * events.
   * @param dragging True when the view is dragged and false when the view is scrolled in the
   * inertia.
   */
