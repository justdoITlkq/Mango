package com.handsomeyang.mango.thrid.mddialog;
...
public class MaterialDialog {
  ...
  private class Builder {
    ...
    private Builder() {
      ...
      View contentView =
          LayoutInflater.from(mContext).inflate(R.layout.layout_material_dialog, null);
      ...
      if (mView != null) {
        LinearLayout linearLayout =
            (LinearLayout) mAlertDialogWindow.findViewById(R.id.contentView);
      ...
      if (mBackgroundResId != -1) {
        LinearLayout linearLayout =
            (LinearLayout) mAlertDialogWindow.findViewById(R.id.material_background);
    ...
    public void setContentView(View contentView) {
      ...
      LinearLayout linearLayout =
          (LinearLayout) mAlertDialogWindow.findViewById(R.id.message_content_view);
