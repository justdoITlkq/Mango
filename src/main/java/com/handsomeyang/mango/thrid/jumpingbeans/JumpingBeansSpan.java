...
final class JumpingBeansSpan extends SuperscriptSpan
  ...
  public JumpingBeansSpan(@NonNull TextView textView, @IntRange(from = 1) int loopDuration,
      @IntRange(from = 0) int position, @IntRange(from = 0) int waveCharOffset,
  ...
  private static boolean isAttachedToHierarchy(View v) {
    ...
    return v.getParent()
        != null;   // Best-effort fallback (without adding support-v4 just for this...)
  }
